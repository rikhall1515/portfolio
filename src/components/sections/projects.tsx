...
import KlardealThumbnail from "/public/klardeal.webp?jsx";
  ...
  return (
    ...
    >
      ...
      <div class="max-w-[120rem] m-auto page-outer-spacing">
        ...
        >
          <a
            class="relative overflow-hidden max-h-[35rem] max-w-[70rem] rounded-xl
            ...
            href="https://klardeal.se"
            aria-labelledby="klardealProject"
          >
            <KlardealThumbnail
          ...
          <div class="flex flex-col gap-8 lg:min-w-[20rem] lg:place-self-end ">
            ...
            <ButtonOutlined text="View Website" href="https://klardeal.se">
              <svg
                class="w-6 h-6"
                viewBox="0 0 98 96"
